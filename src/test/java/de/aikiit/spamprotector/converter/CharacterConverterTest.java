...
public class CharacterConverterTest {
    ...
    public void conversionRoundtripNull() {
        assertNull(CharacterConverter.toEncoded(null));
        assertNull(CharacterConverter.toPlain(null));
    }
    ...
    public void conversionExample() {
        assertEquals(CharacterConverter.SPACE.getReplacement(), CharacterConverter.toEncoded(" "));
        assertEquals(CharacterConverter.SPACE.getPlain(), CharacterConverter.toPlain("&nbsp;"));
    }
